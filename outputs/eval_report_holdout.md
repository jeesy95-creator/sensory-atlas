...
| holdout_003 | True | True | False | fresh_linen, clean_room, warm_cotton | fresh_linen, dry_herb, warm_cotton |
...
| holdout_020 | False | False | True | bark, cedarwood, dry_herb | slate, green_stem, forest_floor |
| holdout_021 | True | True | False | after_rain_garden, green_stem, wet_moss | after_rain_garden, wet_moss, green_stem |
...
| holdout_027 | False | False | False | late_night_air, film_grain, cold_fog | tobacco_leaf, dark_chocolate, velvet |
...
| holdout_040 | False | True | False | cedarwood, old_wood, dry_herb | fresh_linen, warm_cotton, cedarwood |
| holdout_041 | False | False | False | tobacco_leaf, dry_herb, leather | black_tea, warm_cotton, butter_toast |
| holdout_042 | True | True | False | barrel_cellar, old_wood, leather | old_wood, old_library, tobacco_leaf |
...
| holdout_020 | 거친 줄기 표면을 긁었을 때처럼 마르고 어두운 식물성 결 | bark, cedarwood, dry_herb | slate, green_stem, forest_floor |  | low_confidence | Top-1 score is below the low-confidence threshold. |
...
| holdout_027 | 자정이 지난 방의 공기처럼 어둡고 얇게 머무르는 잔향 | late_night_air, film_grain, cold_fog | tobacco_leaf, dark_chocolate, velvet |  | rendering_vs_material_confusion | Rendering target was not represented in detected top 3. |
...
| holdout_040 | 차분한 목재 조각에서 깨끗하고 건조한 향이 가늘게 이어져 | cedarwood, old_wood, dry_herb | fresh_linen, warm_cotton, cedarwood |  | abstract_metaphor_too_broad | Metaphor is broad enough to map to multiple sensory families. |
