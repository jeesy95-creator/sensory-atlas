...
v1.5는 Sensory Atlas의 첫 번째 실제 main ontology expansion입니다. v1.4 candidate review workflow와 v1.4.1 curated shortlist를 거쳐, 후보 중 일부만 `data/sensory_objects.jsonl`에 승격했습니다.
...
- `data/sensory_objects.jsonl`: 8개 curated object 추가
- `data/phrase_cues.json`: 승격 object별 positive/negative cue 추가
- `data/candidate_review_status.jsonl`: 승격 object는 `merged`, 보류 object는 `defer_to_future_batch`로 갱신
- `data/ontology_expansion_v1_5_cases.jsonl`: v1.5 regression/dev case 추가
